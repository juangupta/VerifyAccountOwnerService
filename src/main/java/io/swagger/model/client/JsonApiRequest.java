...
public class JsonApiRequest   {
  @JsonProperty("data")
  @Valid
  private List<ValidateChannelRequest> data = new ArrayList<ValidateChannelRequest>();

  public JsonApiRequest data(List<ValidateChannelRequest> data) {
    this.data = data;
    return this;
  }

  public JsonApiRequest addDataItem(ValidateChannelRequest dataItem) {
  ...
  **/
  ...
  public List<ValidateChannelRequest> getData() {
    return data;
  }

  public void setData(List<ValidateChannelRequest> data) {
    this.data = data;
  }
